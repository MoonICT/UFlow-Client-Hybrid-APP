    ...
    return (
      <SafeAreaView style={Styles.container}>
        ...
        <View style={Styles.row}>
          ...
          <Switch thumbColor={color.primary.main} value={this.state.isSwitchOn} onValueChange={this.onToggleSwitch} />
        ...
        <Text>disable</Text>
        <View style={Styles.row}>
          <Switch disabled={true} value={this.state.isSwitchOn} onValueChange={this.onToggleSwitch} />
          <Text style={DefaultStyle._labelSwitch}>On</Text>
        </View>
      </SafeAreaView>
    );
